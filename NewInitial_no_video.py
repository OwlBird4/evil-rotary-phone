...
motherboard_galaga = pygame.mixer.Sound("Sounds//motherboard_galaga.wav")
...
#-----------------#LEVEL 1 CODE
    ...
    if level == 1:
        ...
        if alien_ship2.x < -100:
            outofbounds -= 1

        if alien_ship3.x < -100:
            outofbounds -= 1

        if alien_ship4.x < -100:
            outofbounds -= 1

        if alien_ship5.x < -100:
            outofbounds -= 1

        if alien_ship6.x < -100:
            outofbounds -= 1

        if alien_ship7.x < -100:
            outofbounds -= 1

        if alien_ship8.x < -100:
            outofbounds -= 1
